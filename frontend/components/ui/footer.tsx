        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">This website is done during the soonami.io hackathon, and is not ready yet for commercial use. This is a basic demo of the functionality. AI can give inaccurate results, bugs can arise.</div>
            </div>
          </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            Copyrights note
            <div className="text-gray-400 text-sm mr-4 flex justify-right">&copy;All rights reserved.</div>
