      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            {/* <h2 className="h2 mb-4">Get a full analysis of your Pitch Deck.</h2> */}
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Combined Rate</h4>
              <p className="text-lg text-gray-400 text-center">Get a combined rate of your Pitch Deck based on multiple factors.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Text Analysis</h4>
              <p className="text-lg text-gray-400 text-center">Using algorithms like OCR and ChatGPT text from your Pitch Deck will be analyzed.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">World-Best Pitch Decks</h4>
              <p className="text-lg text-gray-400 text-center">Our AI algorithms were trained on the best Pitch Decks of the world, such as Bolt, Google, Amazon and others. We can help you to make your Pitch Deck as good as theirs.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Better Design</h4>
              <p className="text-lg text-gray-400 text-center">You can get rates of design for each of your slides, and get advices on what can be improved.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Advices for Improving</h4>
              <p className="text-lg text-gray-400 text-center">Get some meaningful advices on how to improve your presentation. Design, structure, text - everything can be better.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Get Feedback</h4>
              <p className="text-lg text-gray-400 text-center">If you have no one to show your Pitch Deck to, or you want to get feedback before showing it to investors, we got you covered.</p>
            </div>
